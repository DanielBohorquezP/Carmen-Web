...
const retroButtonVariants = cva(
  "relative inline-flex items-center justify-center w-24 border-2 border-transparent rounded-[2px] bg-[#010101] shadow-[1px_1px_1px_rgba(255,255,255,0.6)] transition-colors duration-300",
  {
    variants: {
      variant: {
        default: [
        ...
        // Well Brain nav item: invisible at rest, materializes in pink on hover.
        navGhost: [
          "border-transparent bg-transparent hover:bg-[#010101]",
          "[--bg-color:transparent]",
          "[--bg-color-active:#F5C9E7]",
          "[--shadow-light:#FBE4F2]",
          "[--shadow-dark:#D98FBE]",
          "hover:[--bg-color:#F5C9E7]",
        ],
        // Well Brain "Start Here": gray at rest, brand purple on hover.
        startPurple: [
          "text-white",
          "[--bg-color:theme(colors.neutral.500)]",
          "[--bg-color-active:#7C4FD1]",
          "[--shadow-light:#C9B8EE]",
          "[--shadow-dark:#6B3FC4]",
          "hover:[--bg-color:#9B6FEA]",
        ],
      },
    },
    defaultVariants: {
...
export { RetroButton, retroButtonVariants, retroButtonInnerVariants };
